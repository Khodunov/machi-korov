...
variants=['npz', 'npz-bashneft', 'npz-gazprom-neft', 'npz-rosneft', 'npz-surgutneftegaz', 'npz-tatneft']
...
labels=['00. Исходный','01. Башнефть','02. Газпром нефть','03. Роснефть','04. Сургутнефтегаз','05. Татнефть']
...
sheet.save(root/'cards/npz-six-approved.jpg',quality=95)
