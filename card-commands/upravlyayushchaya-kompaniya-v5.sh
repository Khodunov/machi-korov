...
.venv/bin/python skills/generate-card/scripts/remove_light_background.py \
  buildings/upravlyayushchaya-kompaniya-v5-source.png \
  buildings/upravlyayushchaya-kompaniya-v5.png \
  --background-seed 1044 136 \
  --background-seed 259 154 \
  --background-seed 140 769

.venv/bin/python skills/generate-card/scripts/card_compositor.py \
  --template backgrounds/green.png \
  --overlay buildings/upravlyayushchaya-kompaniya-v5.png \
  --title-icon icons/house-in-gear.png \
  --shadow \
  --output cards/upravlyayushchaya-kompaniya-v5.png \
  --x-frac 0.50 \
  --y-frac 0.50 \
  --scale 0.57 \
  --coin-number 2 \
