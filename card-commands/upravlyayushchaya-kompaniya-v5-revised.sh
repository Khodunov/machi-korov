...
.venv/bin/python skills/generate-card/scripts/remove_light_background.py \
  buildings/upravlyayushchaya-kompaniya-v5-revised-source.png \
  buildings/upravlyayushchaya-kompaniya-v5-revised.png

.venv/bin/python skills/generate-card/scripts/card_compositor.py \
  --template backgrounds/green.png \
  --overlay buildings/upravlyayushchaya-kompaniya-v5-revised.png \
  --title-icon icons/house.png \
  --shadow \
  --output cards/upravlyayushchaya-kompaniya-v5-revised.png \
  --x-frac 0.50 \
  --y-frac 0.50 \
  --scale 0.65 \
  --coin-number 2 \
